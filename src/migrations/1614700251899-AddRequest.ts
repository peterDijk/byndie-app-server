...
export class AddRequest1614700251899 implements MigrationInterface {
    name = 'AddRequest1614700251899'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "requests" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "accepted" boolean NOT NULL, "user_id" uuid, "event_id" uuid, CONSTRAINT "PK_0428f484e96f9e6a55955f29b5f" PRIMARY KEY ("id"))`);
